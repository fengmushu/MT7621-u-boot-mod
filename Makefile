...
#ifeq ($(MT7621_MP), y)
CONFIG_CROSS_COMPILER_PATH ?= $(TOPDIR)/toolchain/mips-2012.03/bin
#else
#CONFIG_CROSS_COMPILER_PATH ?= $(TOPDIR)/toolchain/buildroot-gcc342/bin
#endif
...
LIBS += peripheral/libperipheral.a
